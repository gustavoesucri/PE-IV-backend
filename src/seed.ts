...
async function seedData(dataSource: DataSource) {
  ...
  const companiesData = [
    { nome: 'Tech Solutions Ltda', nomeFantasia: 'Tech Solutions', razaoSocial: 'Tech Solutions Ltda ME', cnpj: '12345678000101', rua: 'Rua da Tecnologia', numero: '100', complemento: 'Sala 101', bairro: 'Centro', cidade: 'São Paulo', estado: 'SP', cep: '01001000', telefone: '11999990001', contatoRhNome: 'Ana Silva', contatoRhEmail: 'rh@techsolutions.com', ativo: true },
    { nome: 'Inovação Digital S.A.', nomeFantasia: 'Inovação Digital', razaoSocial: 'Inovação Digital S.A.', cnpj: '98765432000102', rua: 'Avenida Brasil', numero: '500', complemento: 'Bloco B', bairro: 'Jardim América', cidade: 'Rio de Janeiro', estado: 'RJ', cep: '20040020', telefone: '21999990002', contatoRhNome: 'Carlos Santos', contatoRhEmail: 'rh@inovacaodigital.com', ativo: true },
    { nome: 'Construtora ABC', nomeFantasia: 'ABC Construções', razaoSocial: 'Construtora ABC Ltda', cnpj: '11222333000103', rua: 'Rua das Obras', numero: '250', bairro: 'Industrial', complemento: 'Loja 5', cidade: 'Belo Horizonte', estado: 'MG', cep: '30130000', telefone: '31999990003', contatoRhNome: 'Maria Oliveira', contatoRhEmail: 'rh@construtorabc.com', ativo: true },
    { nome: 'Farmácia Saúde Total', nomeFantasia: 'Saúde Total', razaoSocial: 'Farmácia Saúde Total Ltda', cnpj: '44555666000104', rua: 'Avenida Principal', numero: '75', complemento: 'Apto 201', bairro: 'Vila Nova', cidade: 'Curitiba', estado: 'PR', cep: '80010100', telefone: '41999990004', contatoRhNome: 'João Pereira', contatoRhEmail: 'rh@saudetotal.com', ativo: true },
    { nome: 'Supermarket Express', nomeFantasia: 'Express Market', razaoSocial: 'Supermarket Express Ltda', cnpj: '77888999000105', rua: 'Rua do Comércio', numero: '300', complemento: 'Fundos', bairro: 'Centro', cidade: 'Florianópolis', estado: 'SC', cep: '88010001', telefone: '48999990005', contatoRhNome: 'Lucia Mendes', contatoRhEmail: 'rh@expressmarket.com', ativo: true },
  ];
